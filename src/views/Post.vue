<template>
  <div>
    <div>
      <h1 v-text="Text">Holaaa</h1>
      <router-link :to="paginacion(false)">Anterior</router-link> 
      <router-link :to="paginacion(true)">Siguiente</router-link>
      <p></p>
      <router-link :to="{ name: 'Mensajes' }">Ver Mensaje</router-link>
      <router-view />
    </div>
  </div>
</template>
